...
public:
    ...
    void setFunction(unsigned int flags);
    void setCGRAMAddress(unsigned int address);
    void setDDRAMAddress(unsigned int address);
    unsigned int readBusyFlagAndAddress();
    void writeData(unsigned int data);
    unsigned int readData();
    int update() override;
    void sendData(unsigned int data);
    void sendInstruction(unsigned int instruction);
    void pulseEnable();
    bool isBusy();
